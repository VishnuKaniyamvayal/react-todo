  ...
  const navigate = useNavigate()
    ...
    <div >
        <div className={`flex flex-col px-10 border-[2px] m-4 rounded-lg shadow-xl max-w-[465px] mx-auto z-100 `}>
            ...
            <input  type="password" className='border rounded-md h-12 mb-4 pl-4 border-gray-400' placeholder='Enter your password' onChange={(e)=>{setPassword(e.target.value)}}/>
            <div className='flex flex-row'>
                <button className='mb-4 bg-[#00FFAB] w-20 h-10 justify-center mx-auto rounded-md hover:bg-[#0df2a6] duration-300 focus:bg-[#14C38E] font-medium z-10' onClick={handlelogin}>Login</button>
            </div>
